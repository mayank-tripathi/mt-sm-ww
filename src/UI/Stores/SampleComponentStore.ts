 ...
 * Class should be instantiated only through "instance" getter to always return a new instance of SampleComponentStore
 */
export class SampleComponentStore {
  ...
  /** Static getter to always return a new instance of SampleComponentStore */
  public static get instance(): SampleComponentStore {
    return runInAction("new SampleComponentStore()", () => new SampleComponentStore());
  }
